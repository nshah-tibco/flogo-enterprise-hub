...
cbox(Inches(4.7),Inches(1.7),Inches(3.9),Inches(0.8),CLIENT,
     [("Agentic Chatbot UI",15,WHITE,True),("browser · samples/Agentic_AI/Chatbot",11,RGBColor(0xEA,0xF7,0xEF),False)])
# Orchestrator
...
textbox(s,Inches(0.9),Inches(6.35),Inches(11.5),Inches(0.4),
        "samples/Agentic_AI/Retail_Banking_Assistant_Use_Case",size=14,color=RGBColor(0x9F,0xD8,0xD5))
